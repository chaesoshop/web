...
function changePhone3(){
    ...
    if(phone3.length === 4){
      ...
      document.getElementById("sendMessage").setAttribute("style","background-color:white;")
...
const getToken = () => {
  ...
  // 인증확인 버튼 활성화
  document.getElementById("completion").setAttribute("style","background-color:white;")
...
function checkCompletion(){
  ...
  document.getElementById("signUpButton").setAttribute("style","background-color:white;")
}
